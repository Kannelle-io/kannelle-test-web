...
class TextService {
  static getDefaultTextsByAnimationAndTextLength = (
  ...
  static getLongDefaultTextsByAnimation = (animationName: string) => {
    switch (animationName) {
      ...
      case ANIMATION_KEYS.MAZDA:
        return [
          "My favorite hobbies: pilot very big starships and collect coins",
        ]; // 63 chars
      ...
      case ANIMATION_KEYS.MUSTANG:
        return [
          "My main mission: bring hope, joy and emotions to people who need it",
        ]; // 67 chars
      ...
      case ANIMATION_KEYS.SIMCA:
        return [
          "What whould happen if you were... a dinosaur who likes lollipops?",
        ]; // 65 chars
